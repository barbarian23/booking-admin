...
const getPaggingRateEmployeeReportSage = function* (action) {
    ...
    const { branchCode, fromDate, toDate, page, pageSize } = report;
    try {
        let response = yield call(reportApi.getPagingRateEmployeeReport, branchCode, fromDate, toDate, page, pageSize);
