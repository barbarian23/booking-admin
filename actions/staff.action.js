...
const staffAction = {
    ...
    //update
    UPDATE_STAFF: PREFIX + 'UPDATE_STAFF',
    UPDATE_STAFF_SUCCESS: PREFIX + 'UPDATE_STAFF_SUCCESS',
    UPDATE_STAFF_FAIL: PREFIX + 'UPDATE_STAFF_FAIL',
    ...
    //show update staff 
    SHOW_UPDATE_STAFF_MODAL: PREFIX + 'SHOW_UPDATE_STAFF_MODAL',
    HIDE_UPDATE_STAFF_MODAL: PREFIX + 'HIDE_UPDATE_STAFF_MODAL',
